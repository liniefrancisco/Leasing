...
class PHPExcel_Calculation {
	...
	public static function _unwrapResult($value) {//Replaced by Linie Francisco
		if (is_string($value)) {
			if ((isset($value[0])) && ($value[0] == '"') && (substr($value, -1) == '"')) {
				return substr($value, 1, -1);
			}
	...
	public function parseFormula($formula) {//Replaced by Linie Francisco
		// Basic validation that this is indeed a formula
		// We return an empty array if not
		$formula = trim($formula);
		if ((!isset($formula[0])) || ($formula[0] != '=')) return array();
...
//echo 'Retrieve from cache',PHP_EOL;
	...
	public function _calculateFormulaValue($formula, $cellID=null, PHPExcel_Cell $pCell = null) {//Replaced by Linie Francisco
		$cellValue = '';
