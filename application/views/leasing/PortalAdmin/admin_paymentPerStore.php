          ...
          <div class="row mt">
               <div class="col-md-12">
                    <div class="panel panel-theme">
                         <div class="panel-heading"><i class="fa fa-list"></i> Upload Payment Data (Per Store)</div>
                         <div class="panel-body">
                              <form class="form-horizontal tasi-form" action="#" method="post" id="frm_getLatestPayments">
                                   <div class="row">
                                        <div class="col-md-6">
                                             <section id="unseen">
                                                  <div class="">
                              ...
                              <form method="POST" id="uploadFormPayment">
                                   ...
                                   <div class="row">
                                        <div class="col-md-12">
                                             <section id="unseen">
                                                  <table class="table table-striped table-advance table-hover" id="paymentStore_table">
                                                       <thead>
                                                            <tr>
