...
<div class="container" 
	ng-controller="paymentCntrl" 
	ng-init='getInitData(); clearPaymentData();
		tender_types = <?= $tender_types?>; 
		<?=$this->session->userdata('cfs_logged_in') ? "getCcmCustomers()" : ""?>'>
    <div class="well">
        <div class="panel panel-default">
            <div class="panel-heading <?=$this->session->userdata('cfs_logged_in') ? 'panel-cfs' : 'panel-leasing'?>"><i class="fa fa-pencil-square"></i> Payment</div>
	                                	...
	                                	<div class="col-md-10 col-md-offset-1">
											<div class="row">
												...
												<div class="col-md-6"> <!-- COL-MD-6 DIVIDER -->
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <label for="soa_date" class="col-md-5 control-label text-right">SOA Date</label>
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    <div class="input-group-addon input-date"><strong><i class="fa fa-calendar"></i></strong></div>
                                                                    <datepicker date-format="yyyy-M-dd">
                                                                ...
                                                                <!-- FOR ERRORS -->
                                                                <div class="validation-Error">
                                                                    <span ng-show="frm_payment.soa_date.$dirty && frm_payment.soa_date.$error.required">
                                                                        <p class="error-display">This field is required.</p>
                                                                    </span>
                                                                </div>
                                                            </div>
											...
											<div class="row" ng-init="tender_typeCode = 1">
												<div class="col-md-10 col-md-offset-1">
													<div class="col-md-6 {{tender_typeCode != '2' ? '' : ''}}">
					                                    ...
					                                    <div class="row" ng-if = "tender_typeCode != '1' && tender_typeCode != '3' && tender_typeCode != '11' && tender_typeCode != '12'">
					                                        <div class="form-group">
	                                ...
	                                <div class="row">
	                                	<div class="col-md-12">
	                                		<button 
	                                			...
	                                			class="btn btn-large btn-primary col-md-1 col-md-offset-10"
	                                			type="submit">
