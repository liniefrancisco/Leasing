...
<body class="hold-transition layout-top-nav" ng-clock>
    <div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>adviceHistory" class="nav-link"><i class="fas fa-money-check"></i> Payment Advice History</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="alert alert-info fade show container mt-1" role="alert">
        ...
        <div class="alert alert-info fade show container mt-1" role="alert">
            <strong>Reminder:</strong> Please change your default password to a secure one for security purposes, thank you.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="alert alert-warning fade show container mt-1" role="alert">
            <strong>Reminder:</strong> Penalty will be implemented starting January 2024. Thank you.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
